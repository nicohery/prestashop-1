            ...
            $this->module->name => [
                ...
                'fields' => [
                    ...
                    Ciklik::CONFIG_ENABLE_CREATION_ORDER_STATE => [
                        'type' => 'bool',
                        'title' => $this->l('Enable specific status for subscription creation'),
                        'desc' => $this->l('Use a different order status for the first subscription order. Renewals keep the standard status above.'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                    ],
                    Ciklik::CONFIG_CREATION_ORDER_STATE => [
                        'type' => 'select',
                        'title' => $this->l('Subscription creation order status'),
                        'desc' => $this->l('Status applied to the first subscription order only'),
                        'cast' => 'intval',
                        'identifier' => 'id_order_state',
                        'list' => $available_order_states,
                    ],
                    ...
                    Ciklik::CONFIG_ENABLE_SUBSCRIPTION_CONSENT => [
                        'type' => 'bool',
                        'title' => $this->l('Require subscription consent at checkout'),
                        'desc' => $this->l('Adds a mandatory checkbox at the payment step when the cart contains a subscription. The customer must explicitly acknowledge the automatic renewal before placing the order.'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                    ],
